...
python -m torch.distributed.run --nproc_per_node=4 train_finetune.py --ddp \
    ...
    --pretrained_checkpoint /home/cunyang/scratch.bhatele-lab/T3_pt/allgather10_stage2_output/t3_av_stage2_epoch_50.pt \
    --output_dir ./allgather10_10_finetune_output \
    --epochs 15 \
    --batch_size 20 \
    --learning_rate 5e-5 \
    --warmup_epochs 3 \
